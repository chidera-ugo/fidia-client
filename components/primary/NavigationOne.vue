<template>
  <div
    class="fixed inset-0 z-50 h-64px w-full border-b border-dark-200 bg-white sm:h-72px"
  >
    <div
      class="mx-auto flex h-full max-w-laptop flex-shrink-0 justify-between px-4 align-middle sm:px-8"
    >
      <div class="flex align-middle">
        <NuxtLink
          to="/"
          class="my-auto mr-2.5 flex flex-shrink-0 align-middle focus:outline-none"
        >
          <img src="/icons/logo.jpg" class="mr-2.5" />
          <div class="my-auto text-lg font-bold">Untitled UI</div>
        </NuxtLink>
      ...
      <div class="flex align-middle">
        <!-- upgrade button -->
        <button class="secondary-button mr-4 hidden sm:block">
          <div class="button-slot">
            ...
            <span class="text-left line-clamp-1"> Upgrade now </span>
          </div>
        </button>

        <div class="hidden align-middle sm:flex">
          <!-- settings icon -->
          <button class="icon">
            <svg
              width="20"
          ...
          <!-- notifications icon -->
          <button class="icon mr-4 hidden sm:flex">
            <svg
              width="18"
              height="20"
              class="mx-auto my-auto"
        ...
        <!-- avatar -->
        <button class="hidden flex-shrink-0 sm:block">
          <img :src="user.avatar" class="my-auto h-10 w-10 rounded-full" />
        </button>

        <!-- hamburger menu -->
        <button
          class="-mr-4 ml-4 inline-block p-4 focus:outline-none lg:hidden"
        >
          <svg
            width="20"
            height="15"
            class="my-auto h-6 w-6 text-dark-500"
            viewBox="0 0 20 15"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
